...
For example in order to install plugin v8.14.3+0 for elasticsearch v8.14.3 run

```shell
sudo bin/elasticsearch-plugin install https://github.com/akaula/elasticsearch-opennlp-analysis/releases/download/v8.14.3%2B0/opennlp-analysis-8.14.3+0.zip
```
