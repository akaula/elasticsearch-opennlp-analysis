...
```shell
sudo bin/elasticsearch-plugin install https://github.com/akaula/elasticsearch-opennlp-analysis/releases/download/v8.13.3%2B0/opennlp-analysis-8.13.3+0.zip
```
